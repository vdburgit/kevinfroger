...
import { MapPin, Calendar, Users, Award, ArrowRight, Heart, Building, Zap, Church } from 'lucide-react';
...
const Utrecht = () => {
  ...
  React.useEffect(() => {
    ...
    // Add structured data for Utrecht page
  ...
  const services = [
    {
      title: "Bruiloften Utrecht",
      description: "Romantische bruiloft DJ in de domstad",
    ...
    {
      title: "Privé Feesten",
      description: "Familiefeesten in Utrecht",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-8">
              ...
              <span className="text-orange-400 font-black text-xl tracking-wide">UTRECHT</span>
            </div>
            
            <h1 className="text-5xl lg:text-7xl xl:text-8xl font-black mb-8 leading-tight text-shadow-lg">
              DJ KEVIN FROGER
              <span className="block text-orange-400">UTRECHT</span>
            </h1>
            
            <p className="text-xl lg:text-2xl mb-12 text-blue-100 leading-relaxed max-w-4xl mx-auto">
              Professionele DJ services in Utrecht. Van het centrum tot Leidsche Rijn, 
              van bruiloften in de domstad tot bedrijfsfeesten - altijd de perfecte sfeer in het hart van Nederland.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              DJ SERVICES
              <span className="block text-blue-700">UTRECHT</span>
            </h2>
            <p className="text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Professionele DJ services voor alle gelegenheden in de domstad
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              <h2 className="text-4xl lg:text-5xl font-black text-gray-900 mb-12 text-shadow">
                ALLE WIJKEN
                <span className="block text-orange-500">UTRECHT</span>
              </h2>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {venues.map((venue, index) => (
                  <div key={index} className="bg-white p-4 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
                    <Church className="w-6 h-6 text-blue-500 mx-auto mb-2" />
      ...
      <section id="contact" className="py-32 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              BOEK DJ KEVIN
              <span className="block text-blue-700">IN UTRECHT</span>
            </h2>
