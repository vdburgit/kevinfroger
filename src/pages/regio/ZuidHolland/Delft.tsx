...
import { MapPin, Calendar, Award, ArrowRight, Heart, Building, Zap, GraduationCap } from 'lucide-react';
...
const Delft = () => {
  ...
  React.useEffect(() => {
    ...
    // Add structured data for Delft page
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              <h2 className="text-4xl lg:text-5xl font-black text-gray-900 mb-12 text-shadow">
                ALLE WIJKEN
                <span className="block text-orange-500">DELFT</span>
              </h2>
