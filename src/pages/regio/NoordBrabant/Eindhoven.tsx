...
import { MapPin, Phone, Mail, Calendar, Users, Music, Award, CheckCircle, ArrowRight, Star, Heart, Building, Zap, Lightbulb } from 'lucide-react';
...
const Eindhoven = () => {
  ...
  React.useEffect(() => {
    ...
    // Add structured data for Eindhoven page
  ...
  const services = [
    {
      title: "Bruiloften Eindhoven",
      description: "Romantische bruiloft DJ in de lichtstad",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-8">
              ...
              <span className="text-orange-400 font-black text-xl tracking-wide">EINDHOVEN</span>
            </div>
            
            <h1 className="text-5xl lg:text-7xl xl:text-8xl font-black mb-8 leading-tight text-shadow-lg">
              DJ KEVIN FROGER
              <span className="block text-orange-400">EINDHOVEN</span>
            </h1>
            
            <p className="text-xl lg:text-2xl mb-12 text-blue-100 leading-relaxed max-w-4xl mx-auto">
              Professionele DJ services in Eindhoven. Van het centrum tot Strijp, 
              van bruiloften in de lichtstad tot tech events - altijd de perfecte sfeer in de innovatieve stad.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Professionele DJ services voor alle gelegenheden in de lichtstad
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              <h2 className="text-4xl lg:text-5xl font-black text-gray-900 mb-12 text-shadow">
                ALLE WIJKEN
                <span className="block text-orange-500">EINDHOVEN</span>
              </h2>
