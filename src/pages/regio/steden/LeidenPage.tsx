...
import { MapPin, Calendar, Users, Music, Award, CheckCircle, ArrowRight, Star, Heart, Building, Zap, GraduationCap, Phone, MessageCircle } from 'lucide-react';
...
const LeidenPage = () => {
  ...
  React.useEffect(() => {
    document.title = "DJ Leiden - Professionele DJ services in de sleutelstad | Kevin Froger";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'DJ Leiden - Professionele DJ services in de sleutelstad. Van universiteit tot centrum, van bruiloften tot studentenfeesten. Boek nu!');
    }
  ...
  const services = [
    {
      title: "Bruiloft DJ Leiden",
      description: "Romantische bruiloften in de sleutelstad",
      icon: <Heart className="w-8 h-8" />,
      color: "from-pink-500 to-purple-600"
    },
    {
      title: "Studentenfeest DJ",
      description: "Universiteit Leiden evenementen",
      icon: <GraduationCap className="w-8 h-8" />,
      color: "from-blue-500 to-blue-600"
    },
    {
      title: "Bedrijfsfeest DJ Leiden",
      description: "Corporate events in historische stad",
      icon: <Building className="w-8 h-8" />,
      color: "from-green-500 to-green-600"
    },
    {
      title: "Evenementen DJ Leiden",
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero Section */}
      <section className="py-16 lg:py-24 bg-gradient-to-r from-purple-600 to-blue-700 text-white" role="banner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <GraduationCap className="w-16 h-16 mx-auto mb-6 text-purple-200" />
          <h1 className="text-4xl lg:text-6xl font-black mb-6">
            DJ Leiden - Professionele DJ services in de sleutelstad
          </h1>
          <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            DJ in Leiden voor alle gelegenheden. Van Universiteit Leiden tot historisch centrum, 
            van bruiloften tot studentenfeesten in de sleutelstad.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              DJ SERVICES
              <span className="block text-purple-700">LEIDEN</span>
            </h2>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              BOEK DJ KEVIN
              <span className="block text-purple-700">IN LEIDEN</span>
            </h2>
            <p className="text-2xl text-gray-600 leading-relaxed">
              Klaar om jouw evenement in Leiden onvergetelijk te maken?
            </p>
          </div>
          <ContactForm eventType="Leiden" />
        </div>
      </section>
    </div>
  );
