...
import { MapPin, Calendar, Users, Music, Award, CheckCircle, ArrowRight, Star, Heart, Building, Zap, Anchor, Phone, MessageCircle } from 'lucide-react';
...
const DordrechtPage = () => {
  ...
  React.useEffect(() => {
    document.title = "DJ Dordrecht - Professionele DJ services in de oudste stad | Kevin Froger";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'DJ Dordrecht - Professionele DJ services in de oudste stad van Holland. Van centrum tot Dubbeldam, van bruiloften tot bedrijfsfeesten. Boek nu!');
    }
  ...
  const services = [
    {
      title: "Bruiloft DJ Dordrecht",
      description: "Romantische bruiloften in de oudste stad",
      icon: <Heart className="w-8 h-8" />,
      color: "from-pink-500 to-purple-600"
    },
    {
      title: "Bedrijfsfeest DJ Dordrecht",
      description: "Corporate events in historische stad",
      icon: <Building className="w-8 h-8" />,
      color: "from-blue-500 to-blue-600"
    },
    {
      title: "Verjaardag DJ Dordrecht",
      description: "Privé feesten in alle wijken",
      icon: <Users className="w-8 h-8" />,
      color: "from-green-500 to-green-600"
    },
    {
      title: "Evenementen DJ Dordrecht",
    ...
    <div className="bg-white">
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-red-600 to-orange-700 text-white" role="banner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Anchor className="w-16 h-16 mx-auto mb-6 text-red-200" />
          <h1 className="text-4xl lg:text-6xl font-black mb-6">
            DJ Dordrecht - Professionele DJ services in de oudste stad
          </h1>
          <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            DJ in Dordrecht voor alle gelegenheden. Van centrum tot Dubbeldam, 
            van bruiloften tot bedrijfsfeesten in de oudste stad van Holland.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              DJ SERVICES
              <span className="block text-red-700">DORDRECHT</span>
            </h2>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              BOEK DJ KEVIN
              <span className="block text-red-700">IN DORDRECHT</span>
            </h2>
            <p className="text-2xl text-gray-600 leading-relaxed">
              Klaar om jouw evenement in Dordrecht onvergetelijk te maken?
            </p>
          </div>
          <ContactForm eventType="Dordrecht" />
        </div>
      </section>
    </div>
  );
