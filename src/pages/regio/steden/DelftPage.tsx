...
const DelftPage = () => {
  ...
  React.useEffect(() => {
    document.title = "DJ Delft - Professionele DJ services in de blauwe stad | Kevin Froger";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'DJ Delft - Professionele DJ services in de blauwe stad. Van TU Delft tot centrum, van bruiloften tot studentenfeesten. Boek nu!');
    }
  ...
  const services = [
    {
      title: "Bruiloft DJ Delft",
      description: "Romantische bruiloften in de blauwe stad",
      icon: <Heart className="w-8 h-8" />,
      color: "from-pink-500 to-purple-600"
    },
    {
      title: "Studentenfeest DJ",
      description: "TU Delft en studentenevenementen",
      icon: <GraduationCap className="w-8 h-8" />,
      color: "from-blue-500 to-blue-600"
    },
    {
      title: "Bedrijfsfeest DJ Delft",
      description: "Corporate events in tech stad",
      icon: <Building className="w-8 h-8" />,
      color: "from-green-500 to-green-600"
    },
    {
      title: "Evenementen DJ Delft",
  ...
  const stats = [
    ...
    { number: "30+", label: "TU Delft Events", icon: <GraduationCap className="w-8 h-8" /> }
  ];
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="text-gray-900 font-semibold">Delft</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-blue-700 text-white" role="banner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-black mb-6">
            DJ Delft - Professionele DJ services in de blauwe stad
          </h1>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            DJ in Delft voor alle gelegenheden. Van TU Delft tot historisch centrum, 
            van bruiloften tot studentenfeesten in de technische stad.
          </p>
