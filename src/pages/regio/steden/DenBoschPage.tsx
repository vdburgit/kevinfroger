...
const DenBoschPage = () => {
  ...
  React.useEffect(() => {
    document.title = "DJ Den Bosch - Professionele DJ services in de hoofdstad van Brabant | Kevin Froger";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'DJ Den Bosch - Professionele DJ services in de hoofdstad van Brabant. Van centrum tot buitenwijken, van bruiloften tot bedrijfsfeesten. Boek nu!');
    }
  ...
  const services = [
    {
      title: "Bruiloft DJ Den Bosch",
      description: "Romantische bruiloften in de hoofdstad van Brabant",
      icon: <Heart className="w-8 h-8" />,
      color: "from-pink-500 to-purple-600"
    },
    {
      title: "Bedrijfsfeest DJ Den Bosch",
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-red-600 to-orange-700 text-white" role="banner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-black mb-6">
            DJ Den Bosch - Professionele DJ services in de hoofdstad van Brabant
          </h1>
          <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            DJ in Den Bosch voor alle gelegenheden. Van centrum tot buitenwijken, 
            van bruiloften tot bedrijfsfeesten in de hoofdstad van Noord-Brabant.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              DJ SERVICES
              <span className="block text-red-700">DEN BOSCH</span>
            </h2>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              BOEK DJ KEVIN
              <span className="block text-red-700">IN DEN BOSCH</span>
            </h2>
            <p className="text-2xl text-gray-600 leading-relaxed">
              Klaar om jouw evenement in Den Bosch onvergetelijk te maken?
            </p>
          </div>
          <ContactForm eventType="Den Bosch" />
        </div>
      </section>
    </div>
  );
