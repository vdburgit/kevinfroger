...
import { MapPin, Calendar, Users, Music, Award, CheckCircle, ArrowRight, Star, Heart, Building, Zap, Cookie, Phone, MessageCircle } from 'lucide-react';
...
const GoudaPage = () => {
  ...
  React.useEffect(() => {
    document.title = "DJ Gouda - Professionele DJ services in de kaasstad | Kevin Froger";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'DJ Gouda - Professionele DJ services in de kaasstad. Van centrum tot buitenwijken, van bruiloften tot bedrijfsfeesten. Boek nu!');
    }
  ...
  const services = [
    {
      title: "Bruiloft DJ Gouda",
      description: "Romantische bruiloften in de kaasstad",
      icon: <Heart className="w-8 h-8" />,
      color: "from-pink-500 to-purple-600"
    },
    {
      title: "Bedrijfsfeest DJ Gouda",
      description: "Corporate events in historische stad",
      icon: <Building className="w-8 h-8" />,
      color: "from-blue-500 to-blue-600"
    },
    {
      title: "Verjaardag DJ Gouda",
      description: "Privé feesten in alle wijken",
      icon: <Users className="w-8 h-8" />,
      color: "from-green-500 to-green-600"
    },
    {
      title: "Evenementen DJ Gouda",
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="text-gray-900 font-semibold">Gouda</li>
          </ol>
        </div>
      </nav>

      {/* Hero Section */}
      <section className="py-16 lg:py-24 bg-gradient-to-r from-yellow-600 to-orange-700 text-white" role="banner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Cookie className="w-16 h-16 mx-auto mb-6 text-yellow-200" />
          <h1 className="text-4xl lg:text-6xl font-black mb-6">
            DJ Gouda - Professionele DJ services in de kaasstad
          </h1>
          <p className="text-xl text-yellow-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            DJ in Gouda voor alle gelegenheden. Van historisch centrum tot moderne wijken, 
            van bruiloften tot bedrijfsfeesten in de kaasstad.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              DJ SERVICES
              <span className="block text-yellow-700">GOUDA</span>
            </h2>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              BOEK DJ KEVIN
              <span className="block text-yellow-700">IN GOUDA</span>
            </h2>
            <p className="text-2xl text-gray-600 leading-relaxed">
              Klaar om jouw evenement in Gouda onvergetelijk te maken?
            </p>
          </div>
          <ContactForm eventType="Gouda" />
        </div>
      </section>
    </div>
  );
