...
import { MapPin, Calendar, Users, Award, ArrowRight, Star, Heart, Building, Zap, MessageCircle } from 'lucide-react';
...
const NoordHollandPage = () => {
  ...
  const stats = [
    { number: "15+", label: "Jaar in Noord-Holland", icon: <Award className="w-8 h-8" /> },
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="text-gray-400">/</li>
            <li className="text-gray-900 font-semibold">Noord-Holland</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-red-600 to-red-700 text-white" role="banner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-black mb-6">
            DJ huren in Noord-Holland – complete DJ‑show
          </h1>
          <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            Ervaren allround DJ in Noord-Holland voor bruiloft, verjaardag en events. 
            Van Amsterdam tot Alkmaar - compleet met licht & geluid. Vraag je prijs of offerte.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              DJ SERVICES
              <span className="block text-red-700">NOORD-HOLLAND</span>
            </h2>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              ALLE STEDEN
              <span className="block text-orange-500">NOORD-HOLLAND</span>
            </h2>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              BOEK EEN DJ
              <span className="block text-red-700">IN NOORD-HOLLAND</span>
            </h2>
            <p className="text-2xl text-gray-600 leading-relaxed">
              Klaar om jouw evenement in Noord-Holland onvergetelijk te maken?
            </p>
          </div>
