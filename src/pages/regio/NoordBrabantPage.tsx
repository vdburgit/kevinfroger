...
const NoordBrabantPage = () => {
  ...
  const stats = [
    { number: "15+", label: "Jaar in Noord-Brabant" },
    { number: "300+", label: "Events in de provincie" },
      ...
      <nav aria-label="Breadcrumb" style={{ background: '#f7f3ed', borderBottom: '1px solid rgba(0,0,0,0.08)' }} className="py-3">
        <div className="kf-section-inner py-0">
          <ol className="flex items-center gap-2 text-xs" style={{ color: 'rgba(21,21,21,0.60)' }}>
            ...
            <li>/</li>
            <li style={{ color: '#151515' }} className="font-semibold">Noord-Brabant</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="kf-seo-hero" role="banner">
        <div className="kf-section-inner relative z-10 text-center py-24 lg:py-36">
          <div className="flex items-center justify-center gap-2 mb-5">
            ...
            <span className="kf-eyebrow">Noord-Brabant</span>
          </div>
          <h1 className="kf-hero-title mb-6" style={{ color: '#151515' }}>DJ huren in <span style={{ color: '#e60000' }}>Noord-Brabant</span></h1>
          <p className="kf-hero-subtitle mx-auto mb-10" style={{ maxWidth: '620px', color: 'rgba(21,21,21,0.62)' }}>
            Ervaren allround DJ in Noord-Brabant voor bruiloft, verjaardag en events. Van Eindhoven tot Breda - compleet met licht &amp; geluid. Vraag je prijs of offerte.
          </p>
      ...
      <section className="kf-section" style={{ background: '#ffffff' }}>
        <div className="kf-section-inner">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-black kf-section-title">DJ services Noord-Brabant</h2>
          </div>
          ...
          <div className="mt-14 rounded-2xl p-8" style={{ background: '#fff7e6', border: '1px solid rgba(230,0,0,0.10)' }}>
            <h3 className="text-xl font-bold mb-6" style={{ color: '#151515' }}>Wat je krijgt in Noord-Brabant:</h3>
      ...
      <section className="kf-section" style={{ background: '#fff7e6' }}>
        <div className="kf-section-inner">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-black kf-section-title">Alle steden Noord-Brabant</h2>
      ...
      <section className="kf-section" style={{ background: '#ffffff' }}>
        <div className="kf-section-inner" style={{ maxWidth: '720px' }}>
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black kf-section-title">Boek een DJ in Noord-Brabant</h2>
            <p className="mt-3 text-sm" style={{ color: 'rgba(21,21,21,0.60)' }}>Klaar om jouw evenement in Noord-Brabant onvergetelijk te maken?</p>
          </div>
