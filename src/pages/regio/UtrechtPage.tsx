...
const UtrechtPage = () => {
  React.useEffect(() => {
    document.title = "DJ huren in Utrecht – complete DJ‑show | Kevin Froger";
    ...
    <div style={{ background: '#ffffff', color: '#151515' }}>
      ...
      <section className="kf-seo-hero" role="banner">
        <div className="kf-section-inner relative z-10 text-center py-24 lg:py-36">
          ...
          <h1 className="kf-hero-title mb-6" style={{ color: '#151515' }}>DJ huren in <span style={{ color: '#e60000' }}>Utrecht</span></h1>
          <p className="kf-hero-subtitle mx-auto mb-10" style={{ maxWidth: '620px', color: 'rgba(21,21,21,0.62)' }}>
            Ervaren allround DJ in Utrecht voor bruiloft, verjaardag en events. Van Utrecht stad tot Amersfoort - compleet met licht &amp; geluid. Vraag je prijs of offerte.
          </p>
      ...
      <section className="kf-section" style={{ background: '#ffffff' }}>
        <div className="kf-section-inner">
          ...
          <div className="mt-14 rounded-2xl p-8" style={{ background: '#fff7e6', border: '1px solid rgba(230,0,0,0.10)' }}>
            <h3 className="text-xl font-bold mb-6" style={{ color: '#151515' }}>Wat je krijgt in Utrecht:</h3>
      ...
      <section className="kf-section" style={{ background: '#fff7e6' }}>
        <div className="kf-section-inner">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-black kf-section-title">Alle steden Utrecht</h2>
      ...
      <section className="kf-section" style={{ background: '#ffffff' }}>
        <div className="kf-section-inner" style={{ maxWidth: '720px' }}>
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-black kf-section-title">Boek een DJ in Utrecht</h2>
