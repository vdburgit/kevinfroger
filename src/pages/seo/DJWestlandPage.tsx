...
import { MapPin, Phone, Mail, Calendar, Users, Music, Award, CheckCircle, ArrowRight, Star, Heart, Building, Zap, Flower } from 'lucide-react';
import ContactForm from '../../components/ContactForm';

const DJWestlandPage = () => {
  const services = [
    {
