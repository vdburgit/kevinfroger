...
import { Star, Building, Award, ArrowRight, MessageCircle, Phone, MapPin } from 'lucide-react';
...
const ReviewsPage: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section
        className="py-16 lg:py-24 bg-gradient-to-r from-yellow-500 to-orange-600 text-white"
        role="banner"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-yellow-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            Eerlijke ervaringen van opdrachtgevers door heel NL. Lees hoe we sfeer, techniek en
            organisatie aanpakken.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-7xl font-black text-gray-900 mb-8 text-shadow">
              WAAROM KIEZEN <span className="block text-yellow-600">VOOR KEVIN?</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {achievements.map((a, i) => (
              <div key={i} className="text-center group">
                <div
                  className={`w-24 h-24 bg-gradient-to-br ${a.color} rounded-full flex items-center justify-center mx-auto mb-8 text-white group-hover:scale-110 transition-transform duration-300 shadow-2xl`}
                >
                  {a.icon}
                </div>
                <h3 className="text-2xl font-black text-gray-900 mb-6">{a.title}</h3>
                <p className="text-lg text-gray-600 leading-relaxed">{a.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 bg-gradient-to-br from-yellow-500 to-orange-600 text-white relative overflow-hidden">
        <div className="relative max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-5xl lg:text-7xl font-black mb-8 text-shadow-lg">
            SLUIT JE AAN BIJ <span className="block text-white">TEVREDEN KLANTEN</span>
          </h2>
          <p className="text-xl lg:text-2xl mb-12 text-yellow-100 leading-relaxed max-w-4xl mx-auto">
            Word onderdeel van onze groeiende lijst van tevreden klanten en partners. Ervaar zelf
            waarom bedrijven en particulieren kiezen voor DJ Kevin Froger.
          </p>
