...
const LOC = getLocatie("wantijpaviljoen-dordrecht")!;
const IMG = "/images/dj-kevin-froger-bruiloft-scaled.jpeg";
const PATH = "/feestlocatie/wantijpaviljoen-dordrecht";

export const Route = createFileRoute("/feestlocatie/wantijpaviljoen-dordrecht")({
  head: () =>
    buildSeo({
      title: "DJ bij Partycentrum Wantijpaviljoen | Kevin Froger",
      description: "DJ huren bij Partycentrum Wantijpaviljoen in Dordrecht? Eigen licht en geluid, DJ en MC in een persoon. Vraag je datum aan bij Kevin Froger.",
      path: PATH,
      image: IMG,
      jsonLd: [
        service({
