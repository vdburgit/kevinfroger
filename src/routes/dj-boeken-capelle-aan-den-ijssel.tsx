...
const CITY = CITIES["capelle-aan-den-ijssel"];
const IMG = "/images/dj-kevin-froger-bruiloft-scaled.jpeg";
const PATH = "/dj-boeken-capelle-aan-den-ijssel";

export const Route = createFileRoute("/dj-boeken-capelle-aan-den-ijssel")({
  head: () =>
    buildSeo({
      title: CITY.title,
