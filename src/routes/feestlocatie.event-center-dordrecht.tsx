...
const LOC = getLocatie("event-center-dordrecht")!;
const IMG = "/images/dj-kevin-froger-bruiloft-scaled.jpeg";
const PATH = "/feestlocatie/event-center-dordrecht";

export const Route = createFileRoute("/feestlocatie/event-center-dordrecht")({
  head: () =>
    buildSeo({
      title: "DJ bij Event Center Dordrecht | Kevin Froger",
      description: "DJ huren bij Event Center Dordrecht in Dordrecht? Eigen licht en geluid, DJ en MC in een persoon. Vraag je datum aan bij Kevin Froger.",
      path: PATH,
      image: IMG,
      jsonLd: [
        service({
