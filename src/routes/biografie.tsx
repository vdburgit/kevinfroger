...
const TIMELINE = [
  { y: "2009", t: "Eerste set", d: "Een schoolfeest in de regio. Hier begon het." },
  { y: "2012", t: "Eerste bruiloft", d: "Sindsdien een vast onderdeel van mijn werk, eerst regionaal en daarna door het hele land." },
  { y: "2016", t: "Bedrijfsfeesten", d: "Vaste DJ voor merken als Heineken, Jumbo en Van der Valk." },
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <PageHero
        ...
        intro="Ik begon met draaien als hobby en het werd mijn werk. Inmiddels draai ik feesten voor merken, bruidsparen en festivalbezoekers door heel Nederland, met veel ervaring in de Betuwe, Bommelerwaard, Hoeksche Waard en Zuid-Holland."
        image={IMG}
      ...
      <section className="py-16 px-5 sm:px-6 lg:px-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            ...
            <p>Dat principe combineer ik met een nuchtere, zakelijke aanpak: heldere afspraken, op tijd opbouwen, backup-apparatuur in de auto en korte lijntjes met de organisatie. Geen gedoe, gewoon een avond die loopt.</p>
