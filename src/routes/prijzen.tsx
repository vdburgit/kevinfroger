...
const EXTRAS = [
  { title: "Sfeerverlichting met accuspots", image: "/images/extra-accuspots.webp", alt: "Accuspots die een feestzaal uitlichten in kleur", text: "Zes draadloze accuspots die je hele zaal in kleur zetten. Geen kabels over de vloer en de accu houdt het een avond lang vol. Binnen no-time staat de ruimte in de juiste sfeer." },
  ...
  { title: "Spark-fonteinen", image: "/images/extra-sparks.webp", alt: "Spark fonteinen met vonken op een podium", text: "Het veilige alternatief voor echt vuurwerk binnen. De vonken schieten tot vijf meter de lucht in, zonder brandgevaar en zonder rook. Indrukwekkend voor een opkomst of een speciaal moment." },
