        ...
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link to="/bruiloft-dj-dordrecht" className="rounded-full border-2 border-border text-foreground px-6 py-3 text-xs tracking-[0.18em] uppercase font-bold hover:border-primary transition">Bruiloft DJ Dordrecht</Link>
              <Link to="/bruiloft-dj-rotterdam" className="rounded-full border-2 border-border text-foreground px-6 py-3 text-xs tracking-[0.18em] uppercase font-bold hover:border-primary transition">Bruiloft DJ Rotterdam</Link>
              <Link to="/bruiloft-dj-tiel" className="rounded-full border-2 border-border text-foreground px-6 py-3 text-xs tracking-[0.18em] uppercase font-bold hover:border-primary transition">Bruiloft DJ Tiel</Link>
              <Link to="/bruiloft-dj-betuwe" className="rounded-full border-2 border-border text-foreground px-6 py-3 text-xs tracking-[0.18em] uppercase font-bold hover:border-primary transition">Bruiloft DJ Betuwe</Link>
