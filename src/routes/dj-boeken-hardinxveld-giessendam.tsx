...
const CITY = CITIES["hardinxveld-giessendam"];
const IMG = "/images/dj-kevin-froger-bruiloft-scaled.jpeg";
const PATH = "/dj-boeken-hardinxveld-giessendam";

export const Route = createFileRoute("/dj-boeken-hardinxveld-giessendam")({
  head: () =>
    buildSeo({
      title: CITY.title,
