...
const LOC = getLocatie("postillion-hotel-dordrecht")!;
const IMG = "/images/dj-kevin-froger-bruiloft-scaled.jpeg";
const PATH = "/feestlocatie/postillion-hotel-dordrecht";

export const Route = createFileRoute("/feestlocatie/postillion-hotel-dordrecht")({
  head: () =>
    buildSeo({
      title: "DJ bij Postillion Hotel Dordrecht | Kevin Froger",
      description: "DJ huren bij Postillion Hotel Dordrecht in Dordrecht? Eigen licht en geluid, DJ en MC in een persoon. Vraag je datum aan bij Kevin Froger.",
      path: PATH,
      image: IMG,
      jsonLd: [
        service({
