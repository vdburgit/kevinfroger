...
const LOC = getLocatie("hart-van-de-betuwe-tiel")!;
const IMG = "/images/dj-kevin-froger-bruiloft-scaled.jpeg";
const PATH = "/feestlocatie/hart-van-de-betuwe-tiel";

export const Route = createFileRoute("/feestlocatie/hart-van-de-betuwe-tiel")({
  head: () =>
    buildSeo({
      title: "DJ bij Hart van de Betuwe | Kevin Froger",
      description: "DJ huren bij Hart van de Betuwe in Tiel? Eigen licht en geluid, DJ en MC in een persoon. Vraag je datum aan bij Kevin Froger.",
      path: PATH,
      image: IMG,
      jsonLd: [
        service({
