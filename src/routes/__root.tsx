...
const SAME_AS = [
  ...
  "https://www.google.com/search?kgmid=/g/11stts5fy8",
];
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "DJ Kevin Froger, allround DJ Nederland" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: OG_IMAGE },
      { name: "twitter:image:alt", content: "DJ Kevin Froger, allround DJ Nederland" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {/* HeadContent injecteert per-route meta/title in document.head */}
      <HeadContent />
