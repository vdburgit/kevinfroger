                    ...
                    {slide.map((partner, partnerIndex) => (
                      <div key={partnerIndex} className="group">
                        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-white/20 hover:border-orange-300/50 transform hover:-translate-y-2 hover:scale-105 h-32 flex flex-col">
                          ...
                          {/* Partner Info */}
                          <div className="h-12 flex items-center justify-center px-2 py-1">
                            <h3 className="font-black text-gray-900 text-xs text-center leading-tight group-hover:text-orange-600 transition-colors duration-300 line-clamp-2">
                              {partner.name}
                            </h3>
                          </div>
                        </div>
